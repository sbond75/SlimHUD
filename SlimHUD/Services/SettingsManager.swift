...
class SettingsManager {
    ...
    var firstLaunch: Bool {
        didSet {
            UserDefaultsManager.setItem(false, for: SettingsManager.FirstLaunch)
        }
    }
    ...
    private init() {
        ...
        firstLaunch = UserDefaultsManager.getBool(for: SettingsManager.FirstLaunch, defaultValue: true)
    }
